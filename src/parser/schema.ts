...
export const DIAGNOSTIC_CODES = {
  ...
  PARENT_REVISION_NOT_FOUND: "PARENT_REVISION_NOT_FOUND",
  PARENT_PART_NOT_FOUND: "PARENT_PART_NOT_FOUND",
  SUBSTITUTE_PART_NOT_FOUND: "SUBSTITUTE_PART_NOT_FOUND",
  SUBSTITUTE_REVISION_NOT_FOUND: "SUBSTITUTE_REVISION_NOT_FOUND",
  SUBSTITUTE_SELF_REFERENCE: "SUBSTITUTE_SELF_REFERENCE",
  MISSING_REQUIRED_VALUE: "MISSING_REQUIRED_VALUE",
  INTRINSIC_FIELD_CONFLICT: "INTRINSIC_FIELD_CONFLICT",
} as const;
